...
class SolarMasterCard extends LitElement {
  ...
  static styles = css`
    ...
    .hud-circle-giant { width:75px; height:75px; border-radius:50%; border:3px solid; position:relative; display:flex; align-items:center; justify-content:center; background:rgba(0,0,0,0.8); box-shadow: 0 0 20px rgba(0,0,0,0.5); }
    .hud-circle-giant .v { font-size: 18px; font-weight: 900; }
    ...
    .hud-sub-giant { font-size:12px; text-align:center; color:#00f9f9; font-weight:bold; margin-top: 3px; }

    .rack { background:rgba(255,255,255,0.05); padding:15px; border-radius:18px; margin-bottom:12px; border-left:5px solid #4caf50; }
    .r-grid-compact { display:grid; grid-template-columns:repeat(4, 1fr); text-align:center; font-size:11px; margin-top: 10px; }
...
window.customCards.push({ type: "solar-master-card", name: "Solar Master Card", description: "v2.3.0 - Titan Edition" });
