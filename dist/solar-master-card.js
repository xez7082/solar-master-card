...
class SolarMasterCardEditor extends LitElement {
  ...
  constructor() { super(); this._selectedTab = 'solar_tab'; }
  ...
  render() {
    ...
    return html`
      <div class="tabs">
        ${['solar_tab','batt_tab','eco_tab'].map(t => html`<button class="${this._selectedTab===t?'active':''}" @click=${()=>this._selectedTab=t}>${t.replace('_tab','').toUpperCase()}</button>`)}
      </div>
...
class SolarMasterCard extends LitElement {
  ...
  static styles = css`
    ...
    .s-label { font-size: 9px; opacity: 0.5; display: block; }
