...
class SolarMasterCard extends LitElement {
  ...
  static styles = css`
    ...
    .custom-bg { position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-size: cover; opacity: 0.3; }
    ...
    /* Cockpit */
    .cockpit-container { display: flex; align-items: center; justify-content: space-between; margin-bottom: 25px; min-height: 110px; }
    .cockpit-side { flex: 1; }
    ...
    .mini-diag { background: rgba(255,255,255,0.05); padding: 4px 8px; border-radius: 6px; display: flex; flex-direction: column; border-left: 3px solid #00f9f9; }
    ...
    .mini-diag.empty { visibility: hidden; height: 30px; }
    ...
    .r-f-box { background: #000; padding: 5px; border-radius: 6px; font-size: 9px; text-align: center; }
    .cyan { color: #00f9f9; }
