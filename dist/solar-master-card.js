...
class SolarMasterCardEditor extends LitElement {
  ...
  render() {
    ...
    const schema = [
      ...
      { name: "grid_flow", label: "Consommation Réseau (W)", selector: { entity: {} } },
      { name: "p1_name", label: "Nom Panneau 1" }, { name: "p1_w", label: "Watts P1", selector: { entity: {} } },
      { name: "p2_name", label: "Nom Panneau 2" }, { name: "p2_w", label: "Watts P2", selector: { entity: {} } },
      { name: "p3_name", label: "Nom Panneau 3" }, { name: "p3_w", label: "Watts P3", selector: { entity: {} } },
      { name: "p4_name", label: "Nom Panneau 4" }, { name: "p4_w", label: "Watts P4", selector: { entity: {} } },
...
class SolarMasterCard extends LitElement {
  ...
  _get(id) { 
    return (this.hass && id && this.hass.states[id]) ? this.hass.states[id].state : '0'; 
  }
  ...
  render() {
    ...
    const panels = [
      {n:c.p1_name || 'P1', e:c.p1_w, c:"#ffc107"},
      {n:c.p2_name || 'P2', e:c.p2_w, c:"#00f9f9"},
      {n:c.p3_name || 'P3', e:c.p3_w, c:"#4caf50"},
      {n:c.p4_name || 'P4', e:c.p4_w, c:"#e91e63"}
        ...
        <div class="overlay">
          ...
          <div class="main-content">
            ${this._tab === 'SOLAIRE' ? html`
              ...
              </div>` : html`<div class="page" style="text-align:center; padding:50px;">Onglet en cours de développement...</div>`}
          </div>
  ...
  static styles = css`
    ha-card { background: #000; color: #fff; border-radius: 28px; overflow: hidden; border: 1px solid #333; position: relative; }
    ...
    .overlay { 
      ...
      padding: 15px;
      background: 
        radial-gradient(circle at 50% 0%, rgba(26, 42, 58, 0.8) 0%, #000 75%),
    ...
    .t-badge { background: rgba(255,255,255,0.05); padding: 8px 12px; border-radius: 12px; font-size: 11px; font-weight: 800; border: 1px solid rgba(255,255,255,0.1); backdrop-filter: blur(5px); display: flex; align-items: center; gap: 5px; }
    .green { color: #4caf50; margin-left: auto; border-color: rgba(76, 175, 80, 0.3); }
    
    .header-main { text-align: center; margin-bottom: 30px; }
    .big-val { font-size: 60px; font-weight: 900; color: #ffc107; text-shadow: 0 0 20px rgba(255,193,7,0.3); }
    .obj-text { font-size: 11px; color: #ffc107; font-weight: 900; margin-top: 8px; letter-spacing: 1px; }
    ...
    .unit { font-size: 10px; font-weight: 800; margin-top: -2px; opacity: 0.8; }
    ...
    .f-btn { opacity: 0.4; cursor: pointer; display: flex; flex-direction: column; align-items: center; font-size: 9px; font-weight: bold; transition: 0.3s; }
...
window.customCards.push({
  ...
  name: "Solar Master Card V61",
  preview: true,
  description: "Dashboard Solaire avec Éditeur Visuel"
});
